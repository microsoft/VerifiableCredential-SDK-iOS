...
class ED25519Tests: XCTestCase {
    ...
    func testIsValidSignature() throws {
        ...
        let hash = Data(hexString: "72")
        
        let algo = try ED25519(publicKey: publicKey)
